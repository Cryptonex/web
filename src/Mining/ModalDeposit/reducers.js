...
const processing = (state=false, action) => {
  ...
  switch (action.type) {
    case constants.MINING_DEPOSIT:
      return true;
    case constants.MINING_DEPOSIT_ERROR:
      return false;
    case constants.MINING_DEPOSIT_SUCCESS:
      return false;
    default:
      return state;
  }
...
const showModal = (state=false, action) => {
  ...
  switch (action.type) {
    case constants.MINING_DEPOSIT_SHOW_MODAL:
      return true;
    case constants.MINING_DEPOSIT_CLOSE_MODAL:
      return false;
    default:
      return state;
  }
...
const form = (state=defaultForm, action) => {
  switch (action.type) {
    case constants.MINING_DEPOSIT_UPDATE_FORM:
...
const validateDate = (state=defaultValidate, action) => {
  ...
  switch (action.type){
    ...
    case constants.MINING_DEPOSIT_VALIDATE_FORM:
      return update(state, {
